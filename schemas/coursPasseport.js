...
export default defineType({
  ...
  fields: [
    {
      ...
      title: 'Title',
      type: 'string',
      description: 'The title of the course passeport.',
      validation: (Rule) =>
        Rule.required()
          .min(3)
          .max(100)
    ...
    },
    {
      ...
      description: 'Add one or more images for the course passeport. Each image can have an optional label/credits.',
  ...
  preview: {
    select: {
      ...
      startDate: 'startDate',
      endDate: 'endDate',
      media: 'images.0.image', // show first image in preview
    },
